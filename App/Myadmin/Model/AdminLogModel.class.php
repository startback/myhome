...
class AdminLogModel extends Model {
    ...
    public function get_admin_log_page($page,$where){
        ...
        $base_purl = __ROOT__.'/index.php?m=myadmin&c=admin&a=admin_log_list&admin_id='.$page['admin_id'].'&start_time='.$page['start_time'].'&end_time='.$page['end_time'].'&ip_address='.$page['ip_address'];

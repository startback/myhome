...
<div class="con">
    ...
    <div class="banner_left">
        <div class="banner_left_left">
            <ul>
                <li style="display:block;"><img src="/Public/Home/images/a1.jpg"></li>
                <li><img src="/Public/Home/images/a2.jpg"></li>
                <li><img src="/Public/Home/images/a3.jpg"></li>
                <li><img src="/Public/Home/images/a4.jpg"></li>
            </ul>
        </div>
        <div class="banner_left_right">
            <div class="hover"><img src="/Public/Home/images/hover.png"/></div>
            <ul>
                <li><img src="/Public/Home/images/a1_l.jpg"></li>
                <li><img src="/Public/Home/images/a2_l.jpg"></li>
                <li><img src="/Public/Home/images/a3_l.jpg"></li>
                <li><img src="/Public/Home/images/a4_l.jpg"></li>
                <ul>
        </div>
    </div>
    ...
    <div class="article_left">
        ...
        <?php if($article_list): if(is_array($article_list)): $i = 0; $__LIST__ = $article_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="article_tit">
                    ...
                    <div class="article_tit_txt">
                        ...
                        <a href="/article/article_detail/article_id/<?php echo ($vo["article_id"]); ?>" class="readAll">阅读全文</a>
                    </div>

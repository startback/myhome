                    ...
                    <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                        <div class="form-group">
                            <div class="field field-icon-right">
                                <input type="text" class="input input-big" name="admin_account" placeholder="登录账号"
                        ...
                        <div class="form-group">
                            <div class="field">
                                ...
                                <img src="/myhome/Myadmin/Index/get_code" alt="" width="100" height="32" class="passcode"
                                     style="height:43px;cursor:pointer;" onclick="this.src='/myhome/Myadmin/Index/get_code?'+Math.random()">
